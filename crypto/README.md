...
`import "github.com/kfangw/blockchain/crypto"`

For any specific algorithm, use its specific module e.g.
`import "github.com/kfangw/blockchain/crypto/ed25519"`

If you want to decode bytes into one of the types, but don't care about the specific algorithm, use
`import "github.com/kfangw/blockchain/crypto/amino"`

## Binary encoding

For Binary encoding, please refer to the [Tendermint encoding spec](https://github.com/kfangw/blockchain/blob/master/docs/spec/blockchain/encoding.md).
