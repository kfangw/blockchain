...
import (
	...
	abcicli "github.com/kfangw/blockchain/abci/client"
	...
	"github.com/kfangw/blockchain/abci/version"
	"github.com/kfangw/blockchain/crypto/merkle"
)
...
func muxOnCommands(cmd *cobra.Command, pArgs []string) error {
	if len(pArgs) < 2 {
		return errors.New("expecting persistent args of the form: marshall [command] <...>")
	}
